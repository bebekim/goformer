...
def main(argv=None):
    ...
    # AdamW, not Adam: with weight_decay=0.0 (the default) these are
    # identical, but AdamW's decoupled weight decay is the correct
    # implementation once --weight-decay > 0 -- plain Adam applies L2
    # through the gradient, which interacts badly with its adaptive
    # per-parameter learning rates (Loshchilov & Hutter 2019).
