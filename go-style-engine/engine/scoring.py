...
def evaluate_territory(board):
    """Any points completely surrounded by a single color count as
    territory; no attempt is made to identify dead groups."""
    status = {}
...
def compute_game_result(game_state, komi=DEFAULT_KOMI):
