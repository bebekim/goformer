...
class ZeroEncoder:
    """11-plane board encoding used by the AlphaGo-Zero-style agent:
    0-3 our stones with 1,2,3,4+ liberties; 4-7 opponent stones with
    1,2,3,4+ liberties; 8/9 komi-holder flag; 10 ko-illegal points."""
